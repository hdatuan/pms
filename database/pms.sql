...
(2, 'MANAGER', N'Quản lý dự án và nhân sự'),
(3, 'STAFF', N'Nhân viên thực hiện công việc');

-- USERS (10)
INSERT INTO users (id, email, password, fullname, role_id) VALUES
(1, 'admin@gmail.com', '123456', N'Admin đẹp trai', 1),
(2, 'manager01@gmail.com', '123456', N'Nguyễn Minh Quân', 2),
(3, 'staff.dev01@gmail.com', '123456', N'Phạm Gia Khang', 3);
...
(1, N'Thiết kế schema người dùng', '2026-01-05', '2026-01-20', 1, 1, 3),
(2, N'Nhập liệu khách hàng mẫu', '2026-01-18', '2026-02-05', 2, 2, 2),
(3, N'Xây dựng API đồng bộ lead', '2026-02-03', '2026-03-10', 3, 3, 2),
(4, N'Tạo dashboard tổng hợp KPI', '2026-02-15', '2026-03-25', 1, 4, 1),
(5, N'Kết nối ticket support', '2026-03-05', '2026-04-20', 2, 5, 2),
(6, N'Phát triển giao diện mobile', '2026-03-25', '2026-05-30', 3, 6, 1),
(7, N'Chuẩn hóa báo cáo doanh thu', '2026-02-01', '2026-03-15', 1, 7, 3),
(8, N'Sơ hóa quy trình onboarding HR', '2026-02-10', '2026-04-10', 2, 8, 2),
(9, N'Xây dựng checklist onboarding', '2026-04-05', '2026-05-15', 3, 9, 1),
(10, N'Tối ưu truy vấn tổng hợp', '2026-05-05', '2026-06-20', 1, 10, 2);
