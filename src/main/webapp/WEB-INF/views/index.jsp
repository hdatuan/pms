                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-danger" role="progressbar"
                                                ...
                                                aria-valuemax="100" style="width: ${notStartedPercent}%"> <span
                                                    class="sr-only">${notStartedPercent}% Complete (success)</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-megna" role="progressbar"
                                                ...
                                                aria-valuemax="100" style="width: ${inProgressPercent}%"> <span
                                                    class="sr-only">${inProgressPercent}% Complete (success)</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-primary" role="progressbar"
                                                ...
                                                style="width: ${donePercent}%"> <span class="sr-only">${donePercent}%
