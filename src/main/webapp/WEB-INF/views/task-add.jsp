...
<head>
    ...
    <meta name="description" content="Thêm tác vụ mới - PMS">
    <link rel="icon" type="image/png" sizes="16x16" href="${ctx}/plugins/images/favicon.png">
    <title>Thêm Tác Vụ | Pixel Admin</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Thêm tác vụ mới</h4>
                    </div>
                </div>
                <!-- /.row -->
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="${ctx}/task-add" method="post" id="form-task-add">
                                <!-- Tên tác vụ -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select name="job_id" id="task-job" class="form-control form-control-line" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select name="user_id" id="task-user" class="form-control form-control-line" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select name="status_id" id="task-status" class="form-control form-control-line" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="date" name="start_date" id="task-start-date"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="date" name="end_date" id="task-end-date"
                                            class="form-control form-control-line">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-success" id="btn-submit-task-add">
                                            <i class="fa fa-save"></i> Lưu lại
                                        </button>
                                        <a href="${ctx}/task" class="btn btn-primary" id="btn-back-task-add">
