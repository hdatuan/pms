        ...
        <div class="navbar-default sidebar" role="navigation">
          <div class="sidebar-nav navbar-collapse slimscrollsidebar">
            <ul class="nav" id="side-menu">
              ...
              <li>
                <a href="${ctx}/blank" class="waves-effect"><i class="fa fa-columns fa-fw" aria-hidden="true"></i><span
                ...
                <div class="white-box">
                  <form method="post" action="${ctx}/user-edit" class="form-horizontal form-material">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-12">
                        <input name="fullname" type="text" class="form-control form-control-line"
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-12">
                        <input name="password" type="password" placeholder="Để trống nếu không muốn đổi mật khẩu"
                      ...
                      <div class="col-sm-12">
                        <select name="role-id" class="form-control form-control-line">
                          <c:forEach var="item" items="${roles}">
                            <option value="${item.id}" <c:if test="${editUser != null and item.id == editUser.roleID}">
                              selected
                              </c:if>>
                              ${item.description}
                            </option>
